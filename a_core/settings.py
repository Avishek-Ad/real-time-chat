...
ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'https://real-time-chat-production-8147.up.railway.app/']

CSRF_TRUSTED_ORIGINS = [ 'https://real-time-chat-production-8147.up.railway.app/' ]
